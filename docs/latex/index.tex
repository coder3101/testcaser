...
%% AME https://github.com/coder3101/testcaser/unix_install.sh
\href{https://github.com/coder3101/testcaser/unix_install.sh}{\texttt{ {\bfseries{unix\+\_\+install.\+sh}}}} and 
%% AME https://github.com/coder3101/testcaser/unix_install.sh
\href{https://github.com/coder3101/testcaser/unix_install.sh}{\texttt{ {\bfseries{unix\+\_\+uninstall.\+sh}}}} To install the testcaser on a linux machine {\bfseries{run the install script as a superuser}}.
...
You can head over 
%% AME https://github.com/coder3101/testcaser/examples
\href{https://github.com/coder3101/testcaser/examples}{\texttt{ {\bfseries{here}}}} for more examples of building the test case. 