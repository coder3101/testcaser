...
Compile it and Execute it. You will have a {\bfseries{test.\+txt}} file with the specifed format as in the problem. Rerun it to generate different values.\hypertarget{index_under_standing}{}\section{Understanding Your first Program}\label{index_under_standing}
